...
import com.example.database_demo.administrator.Container;
import com.example.database_demo.database.CommonDatabase;
import com.example.database_demo.student.ActivityStudent;
import com.example.database_demo.teacher.ActivityTeacher;
...
public class Load extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //眼睛睁开闭上
        edit_load_password.setTransformationMethod(PasswordTransformationMethod.getInstance());
            ...
            public void onClick(View v) {
                ...
                if (state == "guanliyuan") {
                    ...
                    if (password_load.equals(true_password) && true_password.equals("") == false) {
                        isr();
                        Intent intent = new Intent(Load.this, ActivityStudent.class);
                    ...
                    if (cursor.getCount() == 0) {
                        ...
                        isr();
                        Intent intent = new Intent(Load.this, ActivityTeacher.class);
        ...
        button_change_password.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Load.this, PasswordChange.class);
                startActivity(intent);
