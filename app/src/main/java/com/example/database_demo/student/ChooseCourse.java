...
public class ChooseCourse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = commonDatabase.getSqliteObject(ChooseCourse.this, "test_db");
                    ...
                    case R.id.choose:
                        ...
                        for (int i = 0; i < c.getCount(); i++) {
                            ...
                            if (string_chongtu.equals("")) {
                                Toast.makeText(ChooseCourse.this, "选课成功！", Toast.LENGTH_SHORT).show();

                            } else {
                                Toast.makeText(ChooseCourse.this, string_chongtu + "重复选中，其他课程选课成功！", Toast.LENGTH_SHORT).show();
                            }
        ...
        //实例化Adapter
        c = new CourseAdapter(ChooseCourse.this, arrayList);
