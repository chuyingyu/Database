...
public class AboutMe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //获取数据库对象
        db = new CommonDatabase().getSqliteObject(AboutMe.this, "test_db");
        ...
        button_jidian.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fenmu < 0.1) {
                    Toast.makeText(AboutMe.this, "您还没有选任何课或您的成绩老师还没有注入哦", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(AboutMe.this, "您的绩点为：" + String.valueOf(fenzi / fenmu), Toast.LENGTH_LONG).show();
                }
