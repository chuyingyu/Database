...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //插入基本测试数据
        String sql_insert1 = "insert into course(teacher_name,course_name,course_weight,course_time,course_period) values('李xx','电路原理',2,'周一34','1')";
        String sql_insert2 = "insert into course(teacher_name,course_name,course_weight,course_time,course_period) values('高x* 刘x','大学英语4',4,'周五67','1')";
        String sql_insert3 = "insert into course(teacher_name,course_name,course_weight,course_time,course_period) values('魏xx','数据库原理',3,'周三36','1')";
        String sql_insert4 = "insert into course(teacher_name,course_name,course_weight,course_time,course_period) values('司xx','计算机操作系统',2,'周一12','1')";
        String sql_insert5 = "insert into course(teacher_name,course_name,course_weight,course_time,course_period) values('司xx','计算机网络',2,'周三6789','1')";
        String sql_insert6 = "insert into course(teacher_name,course_name,course_weight,course_time,course_period) values('王xx','数据结构',4.5,'周五1234','1')";
