 ...
 */
public class DeleteChangeTeacher extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        final SQLiteDatabase db = commonDatabase.getSqliteObject(DeleteChangeTeacher.this,"test_db");

        switch (view.getId())
        {
            case R.id.button_teacher_delete:
                //通过AlertDialog.Builder这个类来实例化我们的一个AlertDialog的对象
                AlertDialog.Builder builder = new AlertDialog.Builder(DeleteChangeTeacher.this);
                //设置Title的图标
                ...
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which)
                    {
                        ...
                        Toast.makeText(DeleteChangeTeacher.this,"删除成功",Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
                //设置一个NegativeButton
            ...
            case R.id.button_teacher_baocun:
                ...
                {
                    Toast.makeText(DeleteChangeTeacher.this,"这个教师号已存在！",Toast.LENGTH_SHORT).show();
                }
