 ...
 * 删除学生信息
 * @author Hao
 * @create 2022/4/9 13:20
 */
public class DeleteChange extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        final SQLiteDatabase db = commonDatabase.getSqliteObject(DeleteChange.this,"test_db");

        switch (view.getId())
        {
            case R.id.button_delete:
                //    通过AlertDialog.Builder这个类来实例化我们的一个AlertDialog的对象
                AlertDialog.Builder builder = new AlertDialog.Builder(DeleteChange.this);
                //    设置Title的图标
