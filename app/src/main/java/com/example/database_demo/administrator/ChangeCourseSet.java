 ...
 * 修改课程信息
 * @author Hao
 * @create 2022/4/9 13:04
 */
public class ChangeCourseSet extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        final SQLiteDatabase db = commonDatabase.getSqliteObject(ChangeCourseSet.this,"test_db");

        switch (view.getId())
        {
            case R.id.button_delete_course:
                //通过AlertDialog.Builder这个类来实例化我们的一个AlertDialog的对象
                AlertDialog.Builder builder = new AlertDialog.Builder(ChangeCourseSet.this);
                //设置Title的图标
