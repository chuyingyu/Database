 ...
 * 用于展示教师信息
 * @author Hao
 * @create 2022/4/9 14:20
 */
public class TeacherAboutMe extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        db = new CommonDatabase().getSqliteObject(TeacherAboutMe.this, "test_db");
