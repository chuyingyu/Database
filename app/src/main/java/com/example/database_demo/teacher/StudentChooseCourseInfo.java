...
/**
 * @author Hao
 * @create 2022/4/9 14:25
 */
public class StudentChooseCourseInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    ...
                    case R.id.button_average_score:
                        ...
                        Toast.makeText(StudentChooseCourseInfo.this, "平均成绩为" + sum / cursor3.getCount(), Toast.LENGTH_LONG).show();
                        break;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(StudentChooseCourseInfo.this, ChangeStudentScore.class);
    ...
    public void init() {
        //声明数据库对象
        db = new CommonDatabase().getSqliteObject(StudentChooseCourseInfo.this, "test_db");
    ...
    public void fenlei_paixu(String order) {
        ...
        //设置适配器
        SimpleAdapter simpleAdapter = new SimpleAdapter(StudentChooseCourseInfo.this, arrayList_student, R.layout.list_item_course_information,
